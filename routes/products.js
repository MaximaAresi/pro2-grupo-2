...
let editValidation = [ // Validaciones para editar un producto, mismas que se usan al crear un producto
    body('nombreProducto').notEmpty().withMessage("Por favor, es necesario que introduzca el nombre del producto").bail(),
    body('descripcionProducto').notEmpty().withMessage("Por favor, es necesario que introduzca una descripcion para el producto"),
]
...
router.post('/edit/:id', editValidation, productsController.edit)
